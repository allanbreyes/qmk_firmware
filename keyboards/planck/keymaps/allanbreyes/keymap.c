...
[3] = LAYOUT_ortho_4x12(
    ...
    KC_TRNS, AU_ON, AU_OFF, MU_ON, MU_OFF, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, DM_RSTP,
    KC_TRNS, KC_TRNS, AG_SWAP, AG_NORM, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
),

// Reset
[4] = LAYOUT_ortho_4x12(
    RESET, EEP_RST, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, EEP_RST, RESET,
